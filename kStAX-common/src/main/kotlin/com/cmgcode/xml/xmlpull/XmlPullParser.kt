 ...
 * in following ways:
 *  * **version**:
 * getProperty(&quot;[http://xmlpull.org/io.v1/doc/properties.html#xmldecl-version](http://xmlpull.org/io.v1/doc/properties.html#xmldecl-version)&quot;)
 * returns String ("1.0") or null if XMLDecl was not read or if property is not supported
 *  * **standalone**:
 * getProperty(&quot;[http://xmlpull.org/io.v1/doc/properties.html#xmldecl-standalone](http://xmlpull.org/io.v1/doc/properties.html#xmldecl-standalone)&quot;)
 ...
 * import io.v1.[KXmlPullParserException](KXmlPullParserException.html);
 * import io.v1.[KXmlPullParserFactory](KXmlPullParserFactory.html);
 *
 * public class SimpleXmlPullApp
 * {
 *
 * public static void main (String args[])
 * throws KXmlPullParserException, IOException
 * {
 * KXmlPullParserFactory factory = KXmlPullParserFactory.newInstance();
 * factory.setNamespaceAware(true);
 * KXmlPullParser xpp = factory.newPullParser();
 *
 * xpp.[setInput](#setInput)( new StringReader ( "&lt;foo>Hello World!&lt;/foo>" ) );
 * int eventType = xpp.getEventType();
 * while (eventType != KXmlPullParser.END_DOCUMENT) {
 * if(eventType == KXmlPullParser.START_DOCUMENT) {
 * System.out.println("Start document");
 * } else if(eventType == KXmlPullParser.START_TAG) {
 * System.out.println("Start tag "+xpp.[getName()](#getName()));
 * } else if(eventType == KXmlPullParser.END_TAG) {
 * System.out.println("End tag "+xpp.getName());
 * } else if(eventType == KXmlPullParser.TEXT) {
...
interface XmlPullParser {
     ...
     * (http://xmlpull.org/io.v1/doc/features.html#detect-encoding),
     ...
     */
    //fun setInput(`in`: Reader) - FROM JAVA IMPLEMENTATION
     ...
     * [http://xmlpull.org/io.v1/doc/features.html#detect-encoding](http://xmlpull.org/io.v1/doc/features.html#detect-encoding)
     ...
     */
    //fun setInput(inputStream: InputStream, inputEncoding: String) - FROM JAVA IMPLEMENTATION
 ...
 * Construction of Internal Entity Replacement Text](http://www.w3.org/TR/REC-xml#intern-replacement).
     ...
     * @see .FEATURE_VALIDATION
     */
    fun defineEntityReplacementText(entityName: String,
     ...
     *
     * **NOTE:** to retrieve list of namespaces declared in current element:<pre>
     * KXmlPullParser pp = ...
 ...
 * 3.3.3 Attribute-Value Normalization](http://www.w3.org/TR/REC-xml#AVNormalize)
     ...
     */
    fun getAttributeValue(namespace: String,
                          name: String): String?
     ...
     *
     * If special feature
     * [FEATURE_XML_ROUNDTRIP](http://xmlpull.org/io.v1/doc/features.html#xml-roundtrip)
     * (identified by URI: http://xmlpull.org/io.v1/doc/features.html#xml-roundtrip)
     ...
     * <br></br>Note: that element content may be delivered in multiple consecutive IGNORABLE_WHITESPACE events.
    </dd> * <dt>CDSECT</dt><dd>
     ...
     * throw new KXmlPullParserException( "expected "+ TYPES[ type ]+getPositionDescription());
    </pre> *
     */
     ...
     * throw new KXmlPullParserException(
     ...
     *
     *
     * **Warning:** Prior to API level 14, the pull parser returned by `android.util.Xml` did not always advance to the END_TAG event when this method was called.
     * Work around by using manually advancing after calls to nextText(): <pre>
     * String text = xpp.nextText();
     * if (xpp.getEventType() != KXmlPullParser.END_TAG) {
     * xpp.next();
     * }
    </pre> *
     */
     ...
     * throw new KXmlPullParserException("expected start or end tag", this, null);
     * }
     * return eventType;
    </pre> *
     */
    ...
    companion object {
         ...
         * @see .setFeature
         */
        val FEATURE_PROCESS_NAMESPACES = "http://xmlpull.org/io.v1/doc/features.html#process-namespaces"
         ...
         * @see .setFeature
         */
        val FEATURE_REPORT_NAMESPACE_ATTRIBUTES = "http://xmlpull.org/io.v1/doc/features.html#report-namespace-prefixes"
         ...
         * @see .setFeature
         */
        val FEATURE_PROCESS_DOCDECL = "http://xmlpull.org/io.v1/doc/features.html#process-docdecl"
         ...
         * @see .setFeature
         */
        val FEATURE_VALIDATION = "http://xmlpull.org/io.v1/doc/features.html#validation"
    }
